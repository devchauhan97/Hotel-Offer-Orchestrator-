 ...
 * @experimental
 */
function extstoreStoreOptions(externalStorage, { initialTarget, deriveContext, limit, abortSignal } = {}) {
    const runner = new external_storage_runner_1.ExternalStorageRunner(externalStorage);
    return {
...
function extstoreRetrieveOptions(externalStorage, { limit, abortSignal } = {}) {
    const runner = new external_storage_runner_1.ExternalStorageRunner(externalStorage);
    return {
 ...
 * @experimental
 */
function extstoreInboundOptions(externalStorage) {
